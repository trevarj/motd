...
class SettingsAndBouncerHeadlessE2eTest : HeadlessE2eDriver() {
    ...
    fun navigatesSettingsPresentationAndBouncerPanels() {
        ...
        scrollToAndClickText("Ayu Light")
        compose.waitForIdle()
        assertTag("settings_theme_sheet")
        scrollToAndClickText("Ayu Dark")
        compose.waitForIdle()
        assertTag("settings_theme_sheet")
        back()
        waitForTagToDisappear("settings_theme_sheet")
        scrollToAndClickTag("settings_switch_true_black")
